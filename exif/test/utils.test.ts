...
Deno.test('parseJson', async (t) => {
  await t.step('parses a JSON array', () => {
    const out = Parse.json(JSON.stringify([SINGLE, { ...SINGLE, FileName: 'b.mp4' }]));
