/* PrismJS 1.30.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+json+markdown+jsx+tsx+regex+rust+typescript */
        ...
        highlightElement: function (n, t, r) {
          ...
          if (
            a.hooks.run('before-sanity-check', s),
              (o = s.element.parentElement) && 'pre' === o.nodeName.toLowerCase() && !o.hasAttribute('tabindex') &&
  ...
  tag: {
    ...
    inside: {
      ...
      'attr-value': {
        pattern: /=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,
        inside: {
          punctuation: [{ pattern: /^=/, alias: 'attr-equals' }, { pattern: /^(\s*)["']|["']$/, lookbehind: !0 }],
        },
      },
      punctuation: /\/?>/,
      ...
      for (var e = [], a = 0; a < n.length; a++) {
        ...
        if (
          ...
          ('tag' === o.type && o.content[0] && 'tag' === o.content[0].type
            ...
            ? e[e.length - 1].openedBraces--
            : i = !0), (i || 'string' == typeof o) && e.length > 0 && 0 === e[e.length - 1].openedBraces
        ) {
          var r = s(o);
          a < n.length - 1 && ('string' == typeof n[a + 1] || 'plain-text' === n[a + 1].type) &&
          (r += s(n[a + 1]), n.splice(a + 1, 1)),
            a > 0 && ('string' == typeof n[a - 1] || 'plain-text' === n[a - 1].type) &&
...
!function (e) {
  ...
  a = a.replace(/<self>/g, function () {
    ...
    e.languages.rust = {
      ...
      'module-declaration': [{ pattern: /(\b(?:crate|mod)\s+)[a-z][a-z_\d]*/, lookbehind: !0, alias: 'namespace' }, {
