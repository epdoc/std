...
import { type FSSortOpts, FSSpec, fsSpec } from '../mod.ts';
...
describe('FSItem Additional Tests', () => {
  ...
  test('sortFiles sorts files correctly', async () => {
    ...
    files = FSSpec.sortByFilename(files);
